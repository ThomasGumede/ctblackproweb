...
def password_reset_request(request):
    try:
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                messages.success(request, "Password reset email was successfully sent. To change your CT Black Pro account password, we first need to verify your account. Check your inbox. If you haven't received, it, please check your spam folder.")
                return redirect("accounts:login")
            else:
                return render(request, "accounts/password/reset-password.html", {"form": form})
    ...
    return render(
        request=request, 
        template_name="accounts/password/reset-password.html", 
        context={"form": form}
        )
    ...
    if user is not None and account_activation_token.check_token(user, token):
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                return render(request, 'accounts/password/reset-password-confirm.html', {'form': form})
